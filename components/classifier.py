...
from components.fc import FCNet, GTH, get_act, get_norm

## adapted from ramen code base
class SimpleClassifier_ramen(nn.Module):
    def __init__(self, in_dim, hid_dim, out_dim, dropout):
        super(SimpleClassifier_ramen, self).__init__()
        layers = [
...
class SimpleClassifier(nn.Module):
    def __init__(self, in_dim, hid_dim, out_dim, norm='weight', act='ReLU', dropout=0.5):
