...
from components.fc import FCNet, GTH, get_norm, FCNet_ramen

## adapted from ramen code base
class UpDnAttention_ramen(nn.Module):
    def __init__(self, v_dim, q_dim, num_hid, dropout=0.2):
        super(UpDnAttention_ramen, self).__init__()

        self.v_proj = FCNet_ramen([v_dim, num_hid])
        self.q_proj = FCNet_ramen([q_dim, num_hid])
...
class Att_3(nn.Module):
    def __init__(self, v_dim, q_dim, num_hid, norm='weight', act='ReLU', dropout=0.0):
