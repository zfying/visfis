...
class WordEmbedding_ramen(nn.Module):
    """Word Embedding
    ...
    def __init__(self, ntoken, emb_dim, dropout=0):
        super(WordEmbedding_ramen, self).__init__()
...
## adapted from ramen code base
class UpDnQuestionEmbedding_ramen(nn.Module):
    def __init__(self, in_dim, num_hid, nlayers, bidirect, dropout=0, rnn_type='GRU'):
        """Module for question embedding
        """
        super(UpDnQuestionEmbedding_ramen, self).__init__()
